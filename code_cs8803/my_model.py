...
from models import display_metrics
...
def my_classifier_predictions(X_train,Y_train,X_test):
    #TODO: complete this
    '''
    rfc = RandomForestClassifier(n_estimators=20, max_depth=10, random_state=545510477)
    ...
    clf = LinearSVC(random_state=545510477, max_iter=10000, loss='hinge')
